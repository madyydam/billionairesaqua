...
export function Footer() {
  return (
    <footer className="relative z-10 border-t border-hairline bg-black/40 px-6 py-20 md:px-10">
      <div className="mx-auto max-w-[1600px]">
        {/* Main Grid */}
        <div className="grid gap-12 sm:grid-cols-2 md:grid-cols-6 mb-16">
          {/* Logo Column */}
          <div className="md:col-span-2 space-y-4">
            <p className="font-display text-base tracking-[0.3em] text-foreground uppercase">
