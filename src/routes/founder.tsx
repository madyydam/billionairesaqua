    ...
    >
      ...
      {/* Ambient atmospheric backdrop lighting */}
        ...
        <main className="relative z-10 pt-28 md:pt-36 pb-24">
          ...
          {/* ========================================================================= */}
          <section className="px-4 sm:px-6 md:px-10 max-w-[1300px] mx-auto">
            <div className="relative rounded-3xl border border-accent-gold/40 bg-gradient-to-br from-black via-neutral-950 to-emerald-950/40 px-4 py-7 sm:p-8 md:p-14 shadow-[0_0_60px_rgba(212,175,55,0.14)] overflow-hidden">
              ...
              <div className="grid lg:grid-cols-12 gap-8 lg:gap-14 items-center">
                ...
                <div className="w-full min-w-0 lg:col-span-5 flex flex-col items-center">
                  <div className="story-hero-item relative group w-full max-w-[280px] sm:max-w-[320px] md:max-w-[360px] aspect-[3/4] rounded-2xl overflow-hidden border border-accent-gold/50 shadow-[0_0_35px_rgba(212,175,55,0.22)] bg-neutral-950 mx-auto">
                    <img
                  ...
                  <div className="story-hero-item mt-6 w-full max-w-[280px] sm:max-w-[320px] md:max-w-[360px] text-left space-y-1.5 mx-auto">
                    <h2 className="font-display text-2xl md:text-3xl tracking-[0.08em] text-accent-gold uppercase font-bold">
                      SURAJ ISHWAR
                    </h2>
                    <p className="font-body text-[0.64rem] sm:text-[0.68rem] md:text-[0.72rem] tracking-[0.10em] sm:tracking-[0.12em] md:tracking-[0.14em] text-white/95 uppercase font-semibold">
                      CO-FOUNDER &amp; CEO - DUDE SALAD
                    </p>
                    <p className="font-body text-[0.64rem] sm:text-[0.68rem] md:text-[0.72rem] tracking-[0.10em] sm:tracking-[0.12em] md:tracking-[0.14em] text-white/95 uppercase font-semibold">
                      FOUNDER &amp; CEO - GADGET DASH™
                    </p>
                    <p className="font-body text-[0.64rem] sm:text-[0.68rem] md:text-[0.72rem] tracking-[0.10em] sm:tracking-[0.12em] md:tracking-[0.14em] text-white uppercase font-semibold">
                ...
                <div className="w-full min-w-0 lg:col-span-7 space-y-6 text-left">
                  ...
                  <h1 className="story-hero-item font-display font-bold text-[clamp(2rem,4.5vw,3.6rem)] tracking-[0.04em] text-foreground uppercase leading-[1.08]">
                    WHERE IT ALL STARTED.
                  </h1>

                  <blockquote className="story-hero-item border-l-2 border-accent-gold pl-4 sm:pl-5 space-y-3 italic text-foreground/90 font-body text-xs sm:text-sm md:text-base leading-relaxed">
                    <p>
                  ...
                  <div className="story-hero-item flex flex-wrap gap-2.5 sm:gap-3 pt-2">
                    <div className="px-3.5 sm:px-4 py-2 rounded-xl bg-black/60 border border-hairline flex items-center gap-2">
                      <Target className="size-4 text-accent-gold shrink-0" />
                      <span className="font-display text-[0.68rem] sm:text-xs tracking-[0.12em] sm:tracking-[0.15em] uppercase text-white font-bold">
                        Target: ₹5,000 Cr by 2030
                      </span>
                    </div>
                    <div className="px-3.5 sm:px-4 py-2 rounded-xl bg-black/60 border border-hairline flex items-center gap-2">
                      <Compass className="size-4 text-accent-gold shrink-0" />
                      <span className="font-display text-[0.68rem] sm:text-xs tracking-[0.12em] sm:tracking-[0.15em] uppercase text-white font-bold">
          ...
          {/* ========================================================================= */}
          <section className="px-4 sm:px-6 md:px-10 max-w-[1200px] mx-auto mt-20 md:mt-28 space-y-12 sm:space-y-16">
            {/* Timeline Item 1: Dude Salad */}
            <div className="story-reveal-card grid lg:grid-cols-12 gap-8 items-start p-5 sm:p-8 md:p-12 rounded-3xl border border-hairline bg-black/40 backdrop-blur-md relative overflow-hidden group hover:border-accent-gold/40 transition-colors duration-500">
            ...
            <div className="story-reveal-card p-5 sm:p-8 md:p-12 rounded-3xl border border-accent-gold/40 bg-gradient-to-br from-emerald-950/50 via-black to-neutral-950 relative overflow-hidden">
          ...
          {/* ========================================================================= */}
          <section className="px-4 sm:px-6 md:px-10 max-w-[1200px] mx-auto mt-24 md:mt-32">
            <div className="story-reveal-card relative rounded-3xl border border-accent-gold/50 bg-gradient-to-b from-neutral-950 via-black to-emerald-950/60 p-5 sm:p-8 md:p-14 overflow-hidden shadow-[0_0_50px_rgba(212,175,55,0.15)]">
          ...
          {/* ========================================================================= */}
          <section className="px-4 sm:px-6 md:px-10 max-w-[1200px] mx-auto mt-24 md:mt-32 space-y-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {/* Card A: The Mindset */}
              <div className="story-reveal-card p-5 sm:p-8 md:p-10 rounded-3xl border border-hairline bg-black/40 space-y-5">
          ...
          {/* ========================================================================= */}
          <section className="px-4 sm:px-6 md:px-10 max-w-[1200px] mx-auto mt-24 md:mt-32">
            <div className="story-reveal-card p-5 sm:p-8 md:p-14 rounded-3xl border border-hairline bg-black/60 space-y-8">
          ...
          {/* ========================================================================= */}
          <section className="px-4 sm:px-6 md:px-10 max-w-[1200px] mx-auto mt-24 md:mt-32">
            <div className="story-reveal-card p-5 sm:p-8 md:p-14 rounded-3xl border border-accent-gold/40 bg-gradient-to-br from-black via-neutral-950 to-emerald-950/50 relative overflow-hidden shadow-[0_0_60px_rgba(212,175,55,0.12)]">
              <div className="max-w-3xl space-y-4">
                <span className="px-3 py-1 rounded-md text-[0.62rem] tracking-[0.25em] font-display uppercase bg-accent-gold/15 border border-accent-gold/40 text-accent-gold font-bold">
              ...
              <div className="mt-10 p-5 sm:p-6 rounded-2xl bg-black/80 border border-accent-gold/30 space-y-3">
          ...
          {/* ========================================================================= */}
          <section className="px-4 sm:px-6 md:px-10 max-w-[1200px] mx-auto mt-20 text-center">
            <div className="p-5 sm:p-8 md:p-12 rounded-3xl border border-hairline bg-black/40 flex flex-col sm:flex-row items-center justify-between gap-6">
