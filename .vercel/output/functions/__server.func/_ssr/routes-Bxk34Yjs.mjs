...
import { a as Mail, c as ArrowDown, i as MapPin, n as Phone, o as CircleQuestionMark, r as Menu, s as ArrowRight, t as X } from "../_libs/lucide-react.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { t as toast } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Bxk34Yjs.js
...
function SmoothScrollProvider({ reducedMotion }) {
	(0, import_react.useEffect)(() => {
		let anchors = [];
		const measure = () => {
			anchors = Array.from(document.querySelectorAll("[data-scene]")).map((node) => {
			...
			}).filter((v) => v !== null).sort((a, b) => a.top - b.top);
		};
		const compute = (y, velocity) => {
			if (anchors.length < 2) {
				setScrollProgress(y / Math.max(1, document.body.scrollHeight - window.innerHeight), velocity);
				return;
			}
...
function Nav() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		className: cn("fixed inset-x-0 top-0 z-50 transition-all duration-700", solid ? "border-b border-hairline bg-background/70 backdrop-blur-xl" : "border-b border-transparent"),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
					...
					children: [LINKS.map((link) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						onClick: () => go(link.id),
						...
						children: [link.label, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute -bottom-1 left-0 h-px w-0 bg-accent-gold transition-all duration-500 group-hover:w-full" })]
					}, link.id)), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						onClick: () => go("contact"),
...
function ProgressRail() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
		...
		children: TIMELINE$1.map((scene, i) => {
			...
			const active = progress >= scene.at - .001 && progress < next;
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: cn("size-1.5 rounded-full transition-all duration-500", active ? "scale-150 bg-foreground" : "bg-muted-foreground/40 group-hover:bg-accent-gold") })
			}, scene.id);
		})
	});
}
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						].map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: [
							...
							"Shipping Policy",
							"Refund Policy"
						].map((policy) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
...
function Section({ id, scene, children, className, labelledBy }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		...
		className: cn("relative z-10 flex min-h-screen w-full items-center px-6 py-24 md:px-10", className),
...
function Eyebrow({ children, className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		className: cn("inline-flex items-center gap-3 rounded-full border border-hairline px-4 py-1.5 font-body text-[0.62rem] tracking-[0.32em] text-muted-foreground uppercase", className),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function Display({ children, className, as: Tag = "h2", id }) {
	const classes = cn("font-display text-[clamp(2.35rem,6.4vw,6.4rem)] leading-[0.95] tracking-[-0.03em] text-foreground uppercase", className);
	if (Tag === "h1") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
		id,
		className: classes,
		children
	});
	if (Tag === "h3") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
		id,
		className: classes,
		children
	});
...
function Body({ children, className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		className: cn("max-w-[42ch] font-body text-[0.95rem] leading-relaxed text-muted-foreground", className),
		children
	});
}
/**
...
function MagneticButton({ variant = "solid", className, children, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
		...
		onMouseMove: move,
		onMouseLeave: leave,
		className: cn("group relative inline-flex items-center justify-center gap-3 rounded-full px-8 py-4 font-body text-[0.72rem] tracking-[0.22em] uppercase transition-colors duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background min-h-11", variant === "solid" && "bg-foreground text-background hover:bg-accent-gold", variant === "outline" && "border border-hairline text-foreground hover:border-accent-gold hover:text-accent-gold", variant === "quiet" && "px-0 text-muted-foreground hover:text-foreground [&>span.line]:hover:w-full", className),
		...props,
		children
	});
}
...
function Hero({ ready }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const tl = gsapWithCSS.timeline({ delay: .55 });
		tl.fromTo(items, {
			opacity: 0,
			y: 34,
			filter: "blur(8px)"
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Section, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			ref: root,
			className: "relative z-10 grid gap-10 md:grid-cols-12 md:items-center",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body, {
							className: "text-white/85 drop-shadow-[0_1px_4px_rgba(0,0,0,0.4)]",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(MagneticButton, {
							...
							children: ["Explore our products", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { className: "size-3.5 transition-transform duration-500 group-hover:translate-x-1" })]
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "relative",
								children: ["Partner with us", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "line absolute -bottom-1 left-0 h-px w-0 bg-current transition-all duration-500" })]
							})
						})]
					})
				]
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-body text-[0.7rem] leading-loose tracking-[0.2em] text-white/70 uppercase",
						children: "Scroll to travel through the product story."
					})
				})
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "pointer-events-none absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 z-10",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "font-body text-[0.55rem] tracking-[0.4em] text-[#00B3C6] uppercase drop-shadow-[0_1px_4px_rgba(0,0,0,0.5)]",
				children: "PUNE • MAHARASHTRA • INDIA"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				className: "flex flex-col items-center gap-1 font-body text-[0.5rem] tracking-[0.32em] text-white/60 uppercase",
...
*/
function Reveal({ children, className, delay = 0, stagger = .09, y = 26 }) {
	const ref = (0, import_react.useRef)(null);
	(0, import_react.useEffect)(() => {
		const el = ref.current;
		if (!el) return;
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eyebrow, { children: "Brand Introduction" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Display, {
						id: "intro-title",
						className: "mt-7 font-editorial normal-case text-5xl",
						children: [
							"More than",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
					className: "w-full",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eyebrow, { children: "The Brand Philosophy" })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eyebrow, { children: "Our Collection" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Display, {
							id: "details-title",
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Product" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex justify-between py-3.5 gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Net Quantity" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-foreground text-right",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex justify-between py-3.5 gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Packaging" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex justify-between py-3.5 gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "MRP" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-foreground text-right",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex justify-between py-3.5 gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Batch No." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex justify-between py-3.5 gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Date of Packaging" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-foreground text-right",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex justify-between py-3.5 gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Use By / Expiry" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-foreground text-right",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex justify-between py-3.5 gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "BIS Standard" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-foreground text-right text-accent-gold-light",
									children: activeProduct.specs.bis
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex justify-between py-3.5 gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "FSSAI License" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "text-foreground text-right text-accent-gold-light",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex justify-between py-3.5 gap-4",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Processor / Manufacturer" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eyebrow, { children: "Our Water" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Display, {
						id: "reveal-title",
					...
					delay: .15,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Body, { children: "At Billionaire's Aqua, we believe quality begins long before the bottle reaches your hands. Our approach focuses on controlled processing, quality checks, hygienic handling and consistent packaging standards." }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: steps.map((step, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							idx < steps.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "hidden md:block absolute top-1/2 -right-2.5 w-5 h-px bg-hairline z-10 group-hover:bg-accent-gold/50 transition-colors" })
						]
					}, step.label))
				})
			})]
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
					className: "w-full",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eyebrow, { children: "See every angle" })
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
					className: "w-full",
					delay: .1,
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eyebrow, { children: "Our Standard" }),
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-px bg-hairline w-full mb-2" })]
						}), PILLARS.map((pillar) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "lg:col-span-5",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						ref: root,
						className: "space-y-4",
						children: QUALITY_ITEMS.map((item, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							"data-tech-row": true,
							"aria-current": active === i ? "true" : void 0,
							className: cn("border-t border-hairline py-6 transition-all duration-700", active === i ? "opacity-100 border-accent-gold/40" : "opacity-35"),
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-baseline gap-5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: cn("font-body text-[0.65rem] tracking-[0.24em] transition-colors duration-500", active === i ? "text-accent-gold" : "text-muted-foreground"),
									children: item.n
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
...
function FullscreenMoment() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Section, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Display, {
				id: "moment-title",
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, {
						...
						children: TIMELINE.map((item, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
							className: "relative",
							delay: idx * .05,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute -left-[1.88rem] top-1.5 size-2 rounded-full bg-accent-gold shadow-[0_0_8px_rgba(212,175,55,0.8)]" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eyebrow, { children: "Leadership" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Display, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
						...
						delay: .2,
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -top-1/4 -right-1/4 size-80 rounded-full bg-accent-gold/5 blur-[80px]" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute -bottom-1/4 -left-1/4 size-80 rounded-full bg-emerald-800/10 blur-[80px]" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-16 h-px bg-accent-gold/40" }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Eyebrow, { children: "Connect With Us" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Display, {
							id: "cta-title",
							className: "mt-4 text-[clamp(2.2rem,4.5vw,3.8rem)] leading-none lowercase first-letter:uppercase",
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							className: `pb-3 font-display text-[0.68rem] tracking-[0.2em] uppercase transition-all duration-500 relative focus-visible:outline-none ${activeTab === "enquiry" ? "text-accent-gold-light font-semibold" : "text-muted-foreground hover:text-accent-gold-light"}`,
							children: ["Enquiries", activeTab === "enquiry" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute bottom-0 left-0 w-full h-0.5 bg-accent-gold-light shadow-[0_0_8px_rgba(0,179,198,0.5)]" })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							onClick: () => setActiveTab("partner"),
							className: `pb-3 font-display text-[0.68rem] tracking-[0.2em] uppercase transition-all duration-500 relative focus-visible:outline-none ${activeTab === "partner" ? "text-accent-gold-light font-semibold" : "text-muted-foreground hover:text-accent-gold-light"}`,
							children: ["Partner With Us", activeTab === "partner" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute bottom-0 left-0 w-full h-0.5 bg-accent-gold-light shadow-[0_0_8px_rgba(0,179,198,0.5)]" })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							onClick: () => setActiveTab("faq"),
							className: `pb-3 font-display text-[0.68rem] tracking-[0.2em] uppercase transition-all duration-500 relative focus-visible:outline-none ${activeTab === "faq" ? "text-accent-gold-light font-semibold" : "text-muted-foreground hover:text-accent-gold-light"}`,
							children: ["FAQs", activeTab === "faq" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute bottom-0 left-0 w-full h-0.5 bg-accent-gold-light shadow-[0_0_8px_rgba(0,179,198,0.5)]" })]
						})
					]
				})]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "size-5 text-accent-gold shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "font-body text-xs tracking-wider space-y-1",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-foreground font-semibold",
										children: "Pune Office"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Pune, PCMC, Maharashtra, India" })]
								})]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-start gap-4 text-muted-foreground",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Mail, { className: "size-5 text-accent-gold shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "font-body text-xs tracking-wider space-y-1",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-foreground font-semibold",
										children: "Email Us"
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "flex items-start gap-4 text-muted-foreground",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Phone, { className: "size-5 text-accent-gold shrink-0 mt-0.5" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "font-body text-xs tracking-wider space-y-1",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-foreground font-semibold",
										children: "Phone Support"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "[Verification Pending]" })]
								})]
							})
						]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Reveal, {
					...
					children: [
						activeTab === "enquiry" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						...
						activeTab === "partner" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						...
						activeTab === "faq" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Reveal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							id: "faq",
							className: "space-y-6",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h4", {
								className: "font-display text-xs tracking-[0.25em] text-accent-gold uppercase mb-4 flex items-center gap-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleQuestionMark, { className: "size-4" }), " Frequently Asked Questions"]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "space-y-4",
...
function Index() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SmoothScrollProvider, { reducedMotion: device.reducedMotion }),
		/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
